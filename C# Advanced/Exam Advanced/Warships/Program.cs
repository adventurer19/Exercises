...
namespace _02._Warships
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(
                    $"It's a draw! Player One has {score[0]} ships left. Player Two has {score[1]} ships left.");
            }
        ...
        private static void Action(char[,] matrix, int row, int col, int[] score)
        {
            if (matrix[row, col] == '#')
            {
                matrix[row, col] = 'X';
